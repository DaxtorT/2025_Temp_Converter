...
class Converter():
    ...
    def __init__(self):
        ...
        # Retrieve 'Help / Info' button
        self.to_help_button = self.button_ref_list[2]


    def check_temp(self,min_temp):
        """
        Checks temperature us valid and either invokes calculation
        ...
        self.temp_error.config(fg="#004C99", font=("Arial", "12", "bold"))
        self.temp_entry.config(bg="#ffffff")

        # Checks that amount to be converted is a numver above absolute zero
        try:
    ...
    def convert(self, min_temp, to_convert):
        ...
        # Enable history button as soon as we have a valid calculation
        self.to_history_button.config(state=NORMAL)

        self.temp_error.config(text=answer_statement)
